...
window.fill(back)
display.set_caption('Кабан способный выходить за рамки возможного (буквально)')
picture = transform.scale(image.load('galaxy_1.jpg'), (700,500))
...
player = Player('boar_004.png', 50,50,100,400, 0,0)
wall1= GameSprite('Wall.png', 250,40, 200,200)
wall2= GameSprite('Wall.png', 40,350, 450,120)
wall3= GameSprite('Wall.png', 200,40, 10,350)
final = GameSprite('monkey.png', 50,50,550,400)
enemy = Enemy('enemy.png', 50,50, 499,200,2)
win = GameSprite('winner_1.jpg', 700,500,0,0)
lose = GameSprite('fail_1.jpg', 700,500,0,0)
